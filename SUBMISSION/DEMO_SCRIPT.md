# REVIVE — Master 5-Minute Demo Script
...
## ⏱️ Precise Timeline & Presentation Flow

### [0:00 – 0:30] The $400B Lost Revenue Dilemma
- **Narration**: Digital merchants lose over $400B annually to payment failures. When payment rails break — like an HDFC Bank UPI degradation — traditional gateways blindly retry on the broken rail, failing 88% of the time. Monitoring dashboards alert you, but can't act. Unconstrained AI bots are too dangerous to move money. REVIVE bridges this gap.
- **Visual**: Control Room ([`/dashboard`](file:///Users/navjotkumarsingh/Desktop/Revive/src/app/dashboard/page.tsx)) displaying live GMV at risk and subsystem status cards.
