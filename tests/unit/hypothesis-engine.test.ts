...
describe('Hypothesis Engine & Mathematical Scoring', () => {
  const dummyIncidentId = '00000000-0000-0000-0000-000000000001';

  it('accurately scores PAYMENT_METHOD_DEGRADATION when UPI fails but cards remain normal', () => {
    ...
    // Top hypothesis should be PAYMENT_METHOD_DEGRADATION
    const top = hypotheses[0];
    expect(top.hypothesis).toBe(CANDIDATE_HYPOTHESES.PAYMENT_METHOD_DEGRADATION);
