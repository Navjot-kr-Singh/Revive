 ...
 * Fetch proposed recovery recommendations for an incident.
 */
export async function GET(
  ...
  try {
    ...
    const recommendations = await InvestigationService.getIncidentRecommendations(merchant.merchantId, incidentId);
